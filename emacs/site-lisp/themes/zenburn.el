...
;; Michael Ilseman's custom changes (original denoted in comment tag old:
...
;;old:          `((background-color . ,zenburn-bg)
          `((background-color . ,zenburn-bg-1)
            (background-mode . dark)
;;old:            (border-color . ,zenburn-bg)
            (border-color . ,zenburn-bg-1)
...
;;old:     `(default ((t (:background ,zenburn-bg :foreground ,zenburn-fg))))
     ...
     `(zenburn-background-2 ((t (:background ,zenburn-bg))))
...
;;old:     '(font-lock-keyword
;;old:       ((t (:inherit zenburn-primary-1))))
...
;;old:                      :box (:color "#1e2320" :line-width 2)))))
     '(mode-line ((t (:foreground "grey60" :background "grey20"
                      :box (:color "#1e2320" :line-width 2)))))
;;old:     '(mode-line-inactive ((t (:background "#2e3330" :foreground "#88b090"
;;old:                               :box (:color "#2e3330" :line-width 2)))))
     '(mode-line-inactive ((t (:background "grey5" :foreground "grey55"
                               :box (:color "#2e3330" :line-width 2)))))
