...
(defun my-theme ()
  "Color theme by Michael Ilseman, based on Artur Hefczyc's calm forest."
  (interactive)
  (color-theme-install
   `(my-theme
...
:height 1.2))))
     ...
     (fringe ((((class color) (background dark)) (:background "grey3"))))
...
"grey90" :box nil))))
     ...
     (menu ((t (nil))))
     (mode-line ((t (:inherit mode-line :background "grey20" :foreground "grey60"))))
     (mode-line-inactive ((t (:inherit mode-line :background "grey5"
                              :foreground "grey55" :weight light))))
